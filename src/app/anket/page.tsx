...
export default function AnketPage() {
  ...
  return (
    <div className="min-h-screen bg-coffee-50">
      {/* Header */}
      <header className="bg-coffee-500 text-white py-6 px-4 text-center">
        <h1 className="text-2xl font-bold">Rhea Cafe</h1>
        <p className="text-coffee-100 mt-1">Geri Bildirim Anketi</p>
      </header>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-6 space-y-6">
          ...
          <div className="text-center mb-4">
            <p className="text-coffee-600">
              Anketi tamamlayarak <strong className="text-coffee-700">%10 indirim kuponu</strong> kazanin!
            </p>
          </div>

          {/* Soru 1: Hizmet Puani */}
          <div>
            <label className="block text-coffee-800 font-medium mb-3">
              ...
              {[1, 2, 3, 4, 5].map((star) => (
                ...
                >
                  <svg
                    ...
                    stroke={star <= serviceRating ? '#F59E0B' : '#CBD5E1'}
                    strokeWidth={1.5}
                    className="w-10 h-10"
                  >
                    <path
            ...
            {serviceRating > 0 && (
              <p className="text-center text-sm text-coffee-500 mt-2">
          ...
          <div>
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-xl border-2 transition-colors ${
                  likedDrinks === true
          ...
          {/* Soru 3: Oneriler */}
          <div>
            <label className="block text-coffee-800 font-medium mb-2">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-coffee-500 focus:outline-none resize-none"
            />
          </div>
          ...
          <div>
            <label className="block text-coffee-800 font-medium mb-2">
              Telefon Numaraniz <span className="text-gray-400 font-normal">(Opsiyonel)</span>
            </label>
            <input
              type="tel"
              value={phone}
              ...
              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-coffee-500 focus:outline-none"
            />
          </div>
          ...
          <button
            ...
            className="w-full py-4 bg-coffee-500 text-white rounded-xl font-semibold text-lg hover:bg-coffee-600 transition-colors disabled:bg-gray-400 flex items-center justify-center gap-2"
          >
            {isSubmitting ? (
              <>
      ...
      {/* Footer */}
      <footer className="text-center py-6 text-coffee-400 text-sm">
